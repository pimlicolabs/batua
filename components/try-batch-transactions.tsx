...
import TestBatchTransaction from "@/components/test-batch-transaction"
import MintErc20Token from "@/components/mint-erc20-token"
import useErc20Balance from "@/hooks/erc20-balance"

export default function TryBatchTransactions() {
    ...
    return (
        <div className="mt-6 p-6 border rounded-lg bg-card shadow-lg">
            ...
            <div className="flex flex-col gap-3 mt-6">
                <TestBatchTransaction erc20Balance={erc20Balance} />
            </div>
        </div>
    )
}
